...
void ZShape::_Shift(const Panel* panel)
{
...
void ZShape::_HtoV(const Panel* panel)
{ 
    Grid start;
    Grid end;
    start.y = m_data[0].y;
...
void ZShape::_VtoH(const Panel* panel)
{
    Grid start;
    Grid end;
    start.x = m_data[0].x;
    ...
    int baseys[] = { firsty - 1, firsty, firsty - 2, firsty + 1 };
