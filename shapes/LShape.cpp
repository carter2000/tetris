...
void LShape::_InitData()
{
    int firstx = 1;
    int firsty = (PANEL_WIDTH - 1) / 2;
    m_data[0].x = firstx;
    m_data[0].y = firsty;
    m_data[1].x = firstx + 1;
    m_data[1].y = firsty;
...
void LShape::_Shift(const Panel* panel)
{
...
void LShape::_UtoL(const Panel* panel)
{
    Grid start;
    Grid end;
    start.x = m_data[0].x;
    ...
    int firstx = m_data[0].x + 2;
    firsty = ((index == 2) ? firsty : firsty - 1);
    m_data[0].x = firstx;
    m_data[0].y = firsty;
    m_data[1].x = firstx;
    m_data[1].y = firsty + 1;
...
void LShape::_LtoD(const Panel* panel)
{
    Grid start;
    Grid end;
    start.y = m_data[0].y;
...
void LShape::_DtoR(const Panel* panel)
{
    Grid start;
    Grid end;
    start.x = m_data[3].x;
...
void LShape::_RtoU(const Panel* panel)
{
    Grid start;
    Grid end;
    start.y = m_data[3].y;
